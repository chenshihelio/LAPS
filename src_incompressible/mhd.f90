program mhd 
    ...
    character(LEN=*),parameter :: format_output_rms = '(6x,a,2x,f10.4,a,1pe10.2,a,1pe10.2,a,1pe12.4)'
    ...
    namelist/pert/ipert,db0,nmode,nmodex,nmodey,nmodez,dbx,dbz,in_out_ratio, &
        dv0,drho0,B0_SB,dB_SB,R0_SB,R1_SB,H_SB,Rm_SB,Rd_SB
    ...
    contains 
        ...
        subroutine evolve 
            ...
            do irk=1,3
                ...
                ! !add pressure to flux in fourier space
                ! call add_pressure_fourier_to_flux_fourier
